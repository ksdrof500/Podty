...
import podcast.com.br.podtche.databinding.ItemDetailBinding;
 ...
 */
public class EpisodesListAdapter extends DataBindingAdapter<ItemDetailBinding, Episodes> {

    private Activity activity;

    public EpisodesListAdapter(Activity activity) {
        super(activity);
    ...
    @Override
    public void onBindViewHolder(BindingViewHolder<ItemDetailBinding> holder, int position) {
        if (holder.binding.getViewModel() == null) {
            holder.binding.setViewModel(new DetailItemViewModel(activity));
        }
