...
public class MediaController implements NotificationManager.NotificationCenterDelegate, SensorEventListener {
    ...
    public boolean playAudio(SongDetail mSongDetail) {
        ...
        if (MusicPreferance.playingSongDetail != null) {
            Intent intent = new Intent(MainApplication.applicationContext, MusicPlayerService.class);
            MainApplication.applicationContext.startService(intent);
        } else {
            Intent intent = new Intent(MainApplication.applicationContext, MusicPlayerService.class);
            MainApplication.applicationContext.stopService(intent);
        }

        storeResendPlay(MainApplication.applicationContext, mSongDetail);
