 ...
 */
package podcast.com.br.podtche.manager;
...
public class MusicPlayerService extends Service implements AudioManager.OnAudioFocusChangeListener, NotificationManager.NotificationCenterDelegate {
    ...
    private void createNotification(SongDetail mSongDetail) {
        try {
            ...
            Intent intent = new Intent(MainApplication.applicationContext, DetailActivity.class);
            intent.setAction("openplayer");
            intent.setFlags(32768);
            PendingIntent contentIntent = PendingIntent.getActivity(MainApplication.applicationContext, 0, intent, 0);
            ...
            Bitmap albumArt = audioInfo != null ? audioInfo.getSmallCover(MainApplication.applicationContext) : null;
...
//                notification.bigContentView.setTextViewText(R.id.player_albumname, albumName);
            ...
            if (remoteControlClient != null) {
                ...
                if (audioInfo != null && audioInfo.getCover(MainApplication.applicationContext) != null) {
                    metadataEditor.putBitmap(RemoteControlClient.MetadataEditor.BITMAP_KEY_ARTWORK,
                            audioInfo.getCover(MainApplication.applicationContext));
                }
